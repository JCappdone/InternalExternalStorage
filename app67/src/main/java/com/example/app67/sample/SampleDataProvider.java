package com.example.app67.sample;
...
public class SampleDataProvider {
    ...
    static {
        ...
        addItem(new DataItem(1, "Chef's Salad", "Salads",
        ...
        addItem(new DataItem(1, "House Salad", "Salads",
        ...
        addItem(new DataItem(1, "Garden Buffet", "Salads",
                "Choose from our fresh local, organically grown ingredients to make a custom salad.",
                4, 10, ""));

        addItem(new DataItem(1, "Mini Cheeseburgers", "Starters",
        ...
        addItem(new DataItem(1, "Panko Stuffed Mushrooms", "Starters",
        ...
        addItem(new DataItem(1, "French Onion Soup", "Starters",
        ...
        addItem(new DataItem(1, "Artichokes with Garlic Aeoli", "Starters",
        ...
        addItem(new DataItem(1, "Parmesan Deviled Eggs", "Starters",
                "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                        "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
                5, 8, "deviled_eggs.jpg"));

        addItem(new DataItem(1, "Classic Burger", "Entrees",
        ...
        addItem(new DataItem(1, "Tomato Bruschetta Tortellini", "Entrees",
        ...
        addItem(new DataItem(1, "Handcrafted Pizza", "Entrees",
        ...
        addItem(new DataItem(1, "Barbecued Tofu Skewers", "Entrees",
        ...
        addItem(new DataItem(1, "Fiesta Family Platter", "Entrees",
        ...
        addItem(new DataItem(1, "Crème Brûlée", "Desserts",
